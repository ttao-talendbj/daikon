...
public class EtcdPropertySourceLocator implements PropertySourceLocator {
    ...
    public EtcdPropertySourceLocator(Client etcd, EtcdConfigProperties properties, ApplicationContext context) {
        this.etcd = etcd;
    ...
    public PropertySource<?> locate(Environment environment) {
        if (environment instanceof ConfigurableEnvironment) {
            ...
            setupContext(contexts, profiles, this.properties.getPrefix(), this.properties.getDefaultContext());
            ...
            for (String context : contexts) {
                EtcdPropertySource propertySource = new EtcdPropertySource(context, etcd, this.context);
                propertySource.init();
