 ...
 *
 * <p>It contains two kinds methods that log audit messages. Very basic info/worning/error methods, which accept
 * all event data as parameters. There are also methods like activityInfo which infers category from method name.
 *
 * <p>It can be extended by a custom interface which can add methods whose
