    ...
    public void testParseNotExpression3() {
        ...
        Criteria expectedCriteria = new Criteria().andOperator(
                new Criteria().orOperator(Criteria.where("field1").ne("value1"),
                        Criteria.where("field1").not()
                                .regex("^([\\x{61}-\\x{7a}]|[\\x{DF}-\\x{F6}]|[\\x{F8}-\\x{FF}]|[\\x{FF41}-\\x{FF5A}])([\\x{61}-\\x{7a}]|[\\x{DF}-\\x{F6}]|[\\x{F8}-\\x{FF}]|[\\x{FF41}-\\x{FF5A}])([\\x{61}-\\x{7a}]|[\\x{DF}-\\x{F6}]|[\\x{F8}-\\x{FF}]|[\\x{FF41}-\\x{FF5A}])([\\x{30}-\\x{39}]|[\\x{FF10}-\\x{FF19}])$")),
