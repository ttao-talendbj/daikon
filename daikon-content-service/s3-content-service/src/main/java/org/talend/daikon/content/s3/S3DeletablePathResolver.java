...
class S3DeletablePathResolver extends AbstractDeletablePathResolver {

    private final AmazonS3 amazonS3;

    private final String bucket;

    S3DeletablePathResolver(ResourcePatternResolver delegate, AmazonS3 amazonS3, String bucket) {
        super(delegate);
