...
import org.talend.daikon.dynamic.context.CommonServiceContextKit
...
class LoggerLevelActorSpec extends CommonServiceContextKit with SpecificationLike with AfterAll with AskSupport {
